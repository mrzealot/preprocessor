...
Még meglepőbb volt számomra a "capo" réteg, akik tulajdonképpen "rab elöljárók" voltak, és gyakran kegyetlenebbül bántak a többi rabbal, mint az igazi börtönőrök.
...
<!-- Fontos azonban megjegyezni, hogy azt a bizonyos "miértet" _ne_ rajtunk kívül álló tényezőhöz kössük!
Ha nem válik valóra egy hamis remény, az akkora törést okozhat, hogy pont amiatt fogjuk elengedni a belső gyeplőt.
És ilyen súlyos körülmények között szó szerint bele lehetett halni a csalódásba. -->
