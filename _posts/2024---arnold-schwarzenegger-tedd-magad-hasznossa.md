...
3 felvonás után leírták
    - lejárt mandátum a nagy válság után
    - megcsalásos házasság robbanás
- de ebből a gödörből is feláll
    - méghozzá ugyanazokkal az eszközökkel, amiket az első három felvonás (testépítés, filmkarrier, politika) során is használt
- az apja gyakran ismételgetett mondata volt ez, hogy "tedd magad hasznossá"
    - ő pedig most megmutat nekünk 7 többé-kevésbé konkrét módot arra, hogy ezt hogy lehet a gyakorlatba ültetni


[Tedd magad hasznossá](https://moly.hu/konyvek/arnold-schwarzenegger-tedd-magad-hasznossa){:target="_blank"} című könyvében.
...
- séta fontossága (Arisztotelész, Nietzsche, Thoreau, Einstein)
    - hagyni kalandozni a gondolatainkat
    - egyáltalán: egyedül lenni a gondolatainkkal
    - nem muszáj El Camino, lehet a parkban vagy bringán

    >> Ha nem találod, amit keresel, legalább egy esélyt adj, hogy az találjon rád.

- vizualizáció fontossága
    - és élénksége, hogy lássuk/halljuk/érezzük
...
- tükörbe nézés fontossága
    - mindannyiunknak megvan egy mentális képe a fejében saját magáról
    - de ezzel párhuzamosan látnunk kell azt is, hogy a világ mit lát, amikor ránk néz
